...
def most_and_least_common_type(treats):
    ...
    >>> treats = [ {'type': 'dessert'}, {'type': 'dessert'}, {'type':'drink'} ]
    ...
    >>> treats = [{'type':'drink'},{'type':'drink'},{'type':'drink'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'drink')

    >>> treats = [{'type':'appetizer'}, {'type':'appetizer'}, {'type':'drink'}, {'type':'drink'}, {'type':'meal'},{'type':'meal'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'drink')
